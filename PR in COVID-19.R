...
Result_Inferential[9, 3] <- paste(round(cohen.d(VAS_Online_Difference, VAS_Brochure_Difference, pooled = TRUE)$conf.int[1], 3), round(cohen.d(VAS_Online_Difference, VAS_Brochure_Difference, pooled = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[9, 6] <- paste(round(cohen.d(New_Online_VAS_Pre, New_Online_VAS_Post, paired = TRUE)$conf.int[1], 3), round(cohen.d(New_Online_VAS_Pre, New_Online_VAS_Post, paired = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[9, 9] <- paste(round(cohen.d(New_Brochure_VAS_Pre, New_Brochure_VAS_Post, paired = TRUE)$conf.int[1], 3), round(cohen.d(New_Brochure_VAS_Pre, New_Brochure_VAS_Post, paired = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[10, 3] <- paste(round(cohen.d(PHQ15_Online_Difference, PHQ15_Brochure_Difference, pooled = TRUE)$conf.int[1], 3), round(cohen.d(PHQ15_Online_Difference, PHQ15_Brochure_Difference, pooled = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[10, 6] <- paste(round(cohen.d(PHQ15_Pre_Online, PHQ15_Post_Online, paired = TRUE)$conf.int[1], 3), round(cohen.d(PHQ15_Pre_Online, PHQ15_Post_Online, paired = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[10, 9] <- paste(round(cohen.d(PHQ15_Pre_Brochure, PHQ15_Post_Brochure, paired = TRUE)$conf.int[1], 3), round(cohen.d(PHQ15_Pre_Brochure, PHQ15_Post_Brochure, paired = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[11, 3] <- paste(round(cohen.d(BI_Online_Difference, BI_Brochure_Difference, pooled = TRUE)$conf.int[1], 3), round(cohen.d(BI_Online_Difference, BI_Brochure_Difference, pooled = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[11, 6] <- paste(round(cohen.d(BI_Pre_Online, BI_Post_Online, paired = TRUE)$conf.int[1], 3), round(cohen.d(BI_Pre_Online, BI_Post_Online, paired = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[11, 9] <- paste(round(cohen.d(BI_Pre_Brochure, BI_Post_Brochure, paired = TRUE)$conf.int[1], 3), round(cohen.d(BI_Pre_Brochure, BI_Post_Brochure, paired = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[12, 3] <- paste(round(cohen.d(GHQ28_Somatic_Online_Difference, GHQ28_Somatic_Brochure_Difference, pooled = TRUE)$conf.int[1], 3), round(cohen.d(GHQ28_Somatic_Online_Difference, GHQ28_Somatic_Brochure_Difference, pooled = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[13, 3] <- paste(round(cohen.d(GHQ28_AnxietyInsomnia_Online_Difference, GHQ28_AnxietyInsomnia_Brochure_Difference, pooled = TRUE)$conf.int[1], 3), round(cohen.d(GHQ28_AnxietyInsomnia_Online_Difference, GHQ28_AnxietyInsomnia_Brochure_Difference, pooled = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[14, 3] <- paste(round(cohen.d(GHQ28_SocialDysfunction_Online_Difference, GHQ28_SocialDysfunction_Brochure_Difference, pooled = TRUE)$conf.int[1], 3), round(cohen.d(GHQ28_SocialDysfunction_Online_Difference, GHQ28_SocialDysfunction_Brochure_Difference, pooled = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[15, 3] <- paste(round(cohen.d(GHQ28_SevereDepression_Online_Difference, GHQ28_SevereDepression_Brochure_Difference, pooled = TRUE)$conf.int[1], 3), round(cohen.d(GHQ28_SevereDepression_Online_Difference, GHQ28_SevereDepression_Brochure_Difference, pooled = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[16, 3] <- paste(round(cohen.d(GHQ28_Total_Online_Difference, GHQ28_Total_Brochure_Difference, pooled = TRUE)$conf.int[1], 3), round(cohen.d(GHQ28_Total_Online_Difference, GHQ28_Total_Brochure_Difference, pooled = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[12, 6] <- paste(round(cohen.d(GHQ28_Somatic_Pre_Online, GHQ28_Somatic_Post_Online, paired = TRUE)$conf.int[1], 3), round(cohen.d(GHQ28_Somatic_Pre_Online, GHQ28_Somatic_Post_Online, paired = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[12, 9] <- paste(round(cohen.d(GHQ28_Somatic_Pre_Brochure, GHQ28_Somatic_Post_Brochure, paired = TRUE)$conf.int[1], 3), round(cohen.d(GHQ28_Somatic_Pre_Brochure, GHQ28_Somatic_Post_Brochure, paired = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[13, 6] <- paste(round(cohen.d(GHQ28_AnxietyInsomnia_Pre_Online, GHQ28_AnxietyInsomnia_Post_Online, paired = TRUE)$conf.int[1], 3), round(cohen.d(GHQ28_AnxietyInsomnia_Pre_Online, GHQ28_AnxietyInsomnia_Post_Online, paired = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[13, 9] <- paste(round(cohen.d(GHQ28_AnxietyInsomnia_Pre_Bruchore, GHQ28_AnxietyInsomnia_Post_Bruchore, paired = TRUE)$conf.int[1], 3), round(cohen.d(GHQ28_AnxietyInsomnia_Pre_Bruchore, GHQ28_AnxietyInsomnia_Post_Bruchore, paired = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[14, 6] <- paste(round(cohen.d(GHQ28_SocialDysfunction_Pre_Online, GHQ28_SocialDysfunction_Post_Online, paired = TRUE)$conf.int[1], 3), round(cohen.d(GHQ28_SocialDysfunction_Pre_Online, GHQ28_SocialDysfunction_Post_Online, paired = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[14, 9] <- paste(round(cohen.d(GHQ28_SocialDysfunction_Pre_Bruchore, GHQ28_SocialDysfunction_Post_Bruchore, paired = TRUE)$conf.int[1], 3), round(cohen.d(GHQ28_SocialDysfunction_Pre_Bruchore, GHQ28_SocialDysfunction_Post_Bruchore, paired = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[15, 6] <- paste(round(cohen.d(GHQ28_SevereDepression_Pre_Online, GHQ28_SevereDepression_Post_Online, paired = TRUE)$conf.int[1], 3), round(cohen.d(GHQ28_SevereDepression_Pre_Online, GHQ28_SevereDepression_Post_Online, paired = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[15, 9] <- paste(round(cohen.d(GHQ28_SevereDepression_Pre_Brochure, GHQ28_SevereDepression_Post_Brochure, paired = TRUE)$conf.int[1], 3), round(cohen.d(GHQ28_SevereDepression_Pre_Brochure, GHQ28_SevereDepression_Post_Brochure, paired = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[16, 6] <- paste(round(cohen.d(GHQ28_Pre_Online, GHQ28_Post_Online, paired = TRUE)$conf.int[1], 3), round(cohen.d(GHQ28_Pre_Online, GHQ28_Post_Online, paired = TRUE)$conf.int[2], 3)) 
...
Result_Inferential[16, 9] <- paste(round(cohen.d(GHQ28_Pre_Brochure, GHQ28_Post_Brochure, paired = TRUE)$conf.int[1], 3), round(cohen.d(GHQ28_Pre_Brochure, GHQ28_Post_Brochure, paired = TRUE)$conf.int[2], 3)) 
